    ...
    <Row class="content">
        ...
        <div class="info-area">
          <ul>
            ...
            <li class="single-line">
              ...
              <p class="idcard-box">
                <img v-for="item in AllInfo.jiben.idcardimg" :src="item" :key="item" alt="">
              </p>
            </li>
            <li class="single-line">
              <p class="label">人脸识别</p>
              <p class="idcard-box">
                <img v-for="(item, index) in AllInfo.jiben.huoti" :src="item" :key="index" alt="">
              </p>
            </li>
          </ul>
        </div>
      ...
      <Col class="record-box" :span="8">
        <div class="nav-box">
          ...
          <a class="nav-block" :class="{cur: NavData.urgeRecord.cur}" @click="NavChange('urgeRecord')" href="javascript:;">催收记录</a>
        </div>
        <div class="base-info" v-show="NavData.baseInfo.cur">
          ...
          <div class="bot-btn">
            <Button type="primary" size="large" v-show="!NavData.baseInfo.IsRemark" @click="AddRemark">修改备注</Button>
          </div>
        </div>
            ...
            <TabPane label="展期">
              ...
              <Card class="card-area" v-for="item in AllInfo.loan.zq_list" :key="item.id">
                <div class="lend-info">
                  <p class="yq_state">{{item.yq_status}}</p>
                  <div class="text-line">
                    <span class="msg-area">延期金额：{{ item.amount }}</span>
